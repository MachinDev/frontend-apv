...
function Formulario() {
  ...
  return (
    <>
    <h2 className="font-black text-3xl text-center">Formulario de Ingreso</h2>
    ...
    <form className="bg-white py-10 px-5 mb-10 md:mb-0 shadow-md rounded-md"onSubmit={handleSubmit}>
        ...
        <div className="mb-5">
            <label htmlFor="fecha" className="text-gray-700 uppercase font-bold">Fecha de Ingreso</label>
        ...
        <input type="submit" value={id ? 'Guardar Cambios' : 'Agregar Paciente'} className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-800 cursor-pointer transition-colors rounded-lg"/>
    </form>
