...
const Paciente = ( {paciente} ) => {
    ...
    const { nombre, email, propietario, fecha, sintomas, _id } = paciente;
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <p className="font-bold uppercase text-indigo-800 my-2">Fecha: <span className="font-normal normal-case text-black">{formatearFecha(fecha)}</span></p>
        ...
        <div className="flex justify-between my-5">
            <button type="button" className="mx-10 py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white uppercase font-bold rounded-lg" onClick={() => setEdicion(paciente)}>
                Editar
            </button>
            <button type="button" className="mx-10 py-2 px-10 bg-red-600 hover:bg-red-700 text-white uppercase font-bold rounded-lg" onClick={() => eliminarPaciente(_id)}>
                Eliminar
            </button>
        </div>
    </div>
