    ...
    <>
            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-lg bg-white'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="submit" value="Iniciar Sesion" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-2 hover:cursor-pointer hover:bg-indigo-800 md:w-auto" />
                </form>
                
                <nav className='mt-10 lg:flex lg:justify-between'>
                    <Link className='block text-center my-5 text-gray-500' to="/registrar">Registra tu cuenta aqui</Link>
